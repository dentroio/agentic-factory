...
_None — engineering queue clear._

---

## Next (operator optional)

| # | Item | Owner | Notes |
|---|------|-------|-------|
| 1 | Enable CD in UI once runner is online | Operator | ✅ `factory-deploy-Mac` online; `FACTORY_CD_ENABLED=true`; manual Deploy green ([run](https://github.com/dentroio/agentic-factory/actions/runs/34977442059)) |
| 2 | Optional weekly spend budget | Operator | Settings → Deploy & Harness → `USAGE_BUDGET_USD_WEEK` (currently `0` = off) |
| 3 | Set `METRICS_ENDPOINT` | Operator | Needs a **public** JSON health URL (not localhost) via Deploy & Harness → Observability |
...
| WO | Title | Merged |
|----|-------|--------|
| WO-1094 | Factory engine CD (runner + enablement) | workflow 2026-09-11; operator enable 2026-09-15 |
...
| WO-1095/1096 | Deploy & Harness + factory guide | 2026-09-11 (#327) |
