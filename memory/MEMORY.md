...
## Known Invariants
- [draft-server-bearer-auth-required](auto_wo1076.md) — All agent-runner HTTP endpoints require API_SECRET bearer auth; orchestrator must send it on every call, enforced by a source-scanning test
