...
## Known Invariants
- [runner-agent-endpoints-pause-and-allowlist](auto_wo1083.md) — All /api/runner/agents/* endpoints must allowlist agent names and refuse actions that start a runner while paused
