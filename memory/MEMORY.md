...
## Known Invariants
- [reviewer-auto-approve-gate-af17](auto_wo1061.md) — Reviewer auto-approval logic (may_auto_approve) and untrusted-diff wrapping are safety invariants (AF-17), not implementation details to casually change
