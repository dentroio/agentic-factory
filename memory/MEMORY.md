...
## Known Invariants
- [agent-runner-eslint9-flat-config-breaks-noeslintrc](auto_wo1105.md) — eslint-plugin-security scan in quality_gate.py must pin eslint@8.x because eslint 9+ dropped --no-eslintrc support
