...
## Known Invariants
- [agent-runner-bounded-subprocess-communicate](auto_wo1069.md) — All subprocess.communicate() calls in agent-runner must go through proc.communicate() with a timeout, never raw asyncio proc.communicate()
