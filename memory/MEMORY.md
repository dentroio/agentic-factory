...
## Known Invariants
- [required-status-checks-list-drift](auto_wo1085.md) — When adding a new required CI check, update both the branch protection ruleset AND scripts/factory_status.py + ENGINEER.md's hardcoded list
