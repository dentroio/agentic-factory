...
## Known Invariants
- [path-traversal-guard-pattern-thread-store](auto_wo1078.md) — Any endpoint that builds filesystem paths from user-supplied IDs (WO ids, filenames) must validate with thread_store.require_wo_id/require_image_filename/contained_path, not raw f-string joins
