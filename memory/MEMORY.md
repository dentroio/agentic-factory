...
## Known Invariants
- [status-site-single-source-invariants](auto_fix-status-site-dashboard-data-integrity-all-seven.md) — Dashboard "counts" (Running, WO throughput, spec ownership) must go through wo_reconcile.py's shared helpers — never re-derived per page/client
