...
## Known Invariants
- [dashboard-auth-model-status-site](auto_wo1059.md) — Factory status-site dashboard auth model — bearer token OR same-origin loopback Origin, no login page, fails closed on missing API_SECRET
