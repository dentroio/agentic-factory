...
## Known Invariants
- [sqlite-write-behind-writer-state](auto_wo1079.md) — services/orchestrator/db.py has a background write-behind thread for SQLite sync; tests must reset it explicitly and errors surface on the *next* call, not immediately
