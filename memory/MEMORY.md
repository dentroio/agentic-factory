...
## Known Invariants
- [orchestrator-json-writes-must-be-atomic](auto_wo1084.md) — All JSON state file writes in orchestrator must use dispatch_control.atomic_write_json, never Path.write_text
