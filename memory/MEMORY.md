...
## Known Invariants
- [secrets-api-allowlist-invariant](auto_wo1080.md) — PUT /api/secrets only accepts keys in secrets_policy.ALLOWED_SECRET_KEYS; new secret types must be added there explicitly
