...
## Known Invariants
- [wo-status-logic-triplicated-across-repo](auto_fix-status-stop-counting-filing-prs-and-emoji-stat.md) — wo status/PR-completion classification logic is duplicated in three files and must be kept in sync via a parity test
