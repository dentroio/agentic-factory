...
## Known Invariants
- [wo-detail-page-must-use-apply-live-status-fallback](auto_wo486.md) — wo_detail() route must reconcile via apply_live_status() before 404ing, not just look for a spec file
