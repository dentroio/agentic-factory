...
## Known Invariants
- [workflow-concurrency-groups-required](auto_wo1074.md) — All GitHub workflow YAML files must declare a `concurrency:` block; risk-tier-approval.yml must keep cancel-in-progress false
