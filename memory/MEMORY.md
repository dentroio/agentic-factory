...
## Known Invariants
- [risk-tier-workflow-no-cancel-in-progress](auto_wo1071.md) — The risk-tier-approval required check workflow must never use cancel-in-progress:true, and its label-check script polls briefly to avoid races
