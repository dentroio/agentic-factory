...
## Known Invariants
- [orchestrator-poll-cycle-loop-isolation](auto_wo1066.md) — poll() sweep loops over dispatch/preflight state must re-read entries after any await and wrap per-item work in try/except
