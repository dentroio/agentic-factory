...
## Known Invariants
- [factory-github-token-must-be-fine-grained-pat](auto_wo1058.md) — Factory GitHub token in Keychain must be a fine-grained github_pat_ token; classic ghp_ and CLI gho_/ghu_ tokens are rejected
