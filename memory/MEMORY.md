...
## Known Invariants
- [runner-auth-privilege-escalation-gap](auto_wo1090.md) — /api/runners/register and /api/runners/{id}/revoke are reachable by any active runner token, not just the master API_SECRET
