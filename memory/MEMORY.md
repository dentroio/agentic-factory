...
## Known Invariants
- [ci-jobs-must-mirror-in-make-ci-local](auto_wo1072.md) — New CI/CD jobs must be added to `make ci-local` too, and enforced via tests/unit/test_ci_local_mirrors_ci.py
