...
## Known Invariants
- [orchestrator-no-self-http-calls](auto_wo1077.md) — Orchestrator must call its own endpoint handler functions directly, never HTTP-round-trip to its own API via localhost/127.0.0.1
