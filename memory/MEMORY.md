...
## Known Invariants
- [orchestrator-sqlite-must-use-db-connect-helper](auto_wo1068.md) — All factory.db access in orchestrator.py must go through db.py's connect() helper, not raw sqlite3.connect()
