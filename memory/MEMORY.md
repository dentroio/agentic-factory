...
## Known Invariants
- [dispatch-attempt-counts-persist-separately](auto_wo1060.md) — DELETE /api/dispatch does not reset WO retry attempt counts — they live in a separate side file cleared only via /reset
