...
## Known Invariants
- [agent-config-put-allowlist-required](auto_wo1082.md) — PUT /api/config on the orchestrator must only accept allowlisted keys, never raw merge of incoming JSON
