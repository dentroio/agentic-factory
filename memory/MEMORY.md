...
## Known Invariants
- [af-12-secret-handling-pattern](auto_wo1056.md) — Factory secrets (Keychain/OAuth/LaunchAgent env vars) must never touch disk world-readable or stdout — use 0600 temp files, plistlib, and compose-with-env.sh
