...
## Known Invariants
- [wrap-untrusted-content-in-agent-prompts](auto_fix-runner-treat-wo-markdown-as-untrusted-prompt-d.md) — Any WO markdown, rejection reason, CI analysis, or other externally/attacker-influenced text embedded in agent prompts must go through prompt_builder.wrap_untrusted()
