...
## Known Invariants
- [orchestrator-anthropic-calls-must-use-llm-client-wrapper](auto_wo1067.md) — All Anthropic SDK message calls in orchestrator/intelligence must go through llm_client.messages_create, never client.messages.create directly
