...
## Known Invariants
- [ci-local-timeout-contention-recurring](auto_wo443.md) — quality_gate.py's _CI_RUN_TIMEOUT/_CI_LOCK_TIMEOUT bumps are symptom fixes, not root-cause fixes — expect recurrence under host contention
