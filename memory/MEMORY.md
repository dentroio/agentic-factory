...
## Known Invariants
- [memory-index-auto-populated](auto_fix-af-38-memory-system-was-write-only-index-never.md) — MEMORY.md indexing is now automatic in memory_agent.py — don't rely on manual index steps in PR templates
