...
## Known Invariants
- [ci-local-must-mirror-ci-yml](auto_fix-tooling-ai-review-gate-cannot-review-large-dif.md) — make ci-local exists and is tested to mirror ci.yml's pytest invocation exactly — changing one without the other breaks a test
