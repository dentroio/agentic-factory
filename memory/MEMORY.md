...
## Known Invariants
- [dependabot-yml-not-template](auto_wo1073.md) — GitHub only reads .github/dependabot.yml (not .template files); config must list every services/*/requirements.txt directory explicitly
